...
<body>
    ...
    <div class="left">
        <div class="prebackground"></div>
        <div class="dropzone" id="dropzone">ARRASTRA TUS ARCHIVOS AQUÍ</div>
        <label for="fileupload" class="uploadbutton" onclick="displayUpload()">Subir archivos</label>
        <input id="fileupload" type="file" name="fileupload" hidden/> 
        <button id="upload-button" class="uploadbutton upbut hidden" onclick="uploadFile()"> Upload </button>
    </div>
        ...
        <div class="loginzone">
            <div class="relative">
                ...
                <a href="#" class="botoupload">
                    ...
                    <span class="logingoogle">Login con Google</span>
                </a>
            </div>
        </div>
    </div>
